...
source("bin/refcds_masker_for_dndscv_clean_v3.R")

many_burdens = read.table("./data/rmd_input/combined_B_mem_1_final.tsv",sep="\t",header=T)
...
subsetrefcds(regions_to_be_masked=exons_gr,
             genomefile="data/reference/1kgp/GRCh37/hs37d5.fa",
             refcds="./data/rmd_input/RefCDS_GRCh37_v1.NSXupdate.Rdat",
